...
output_index = 1
xlabel_text = "Lag time τlag (min)"
#xlabel_text = "Peak FIIa (nmol/L)"
#xlabel_text = "Peak time FIIa (min)"
#xlabel_text = "Max FIIa rate (nmol/L-min)"
...
# dump fig -
fig_file_name = "Fig-distribution-OI-$(output_index)-w-RS-TM-0-MC-0.pdf"
